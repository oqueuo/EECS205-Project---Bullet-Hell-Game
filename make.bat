...
set MASMPATH=C:\Programs\MASM32\bin
...
set MASMLIBPATH=C:\Programs\MASM32\lib
...
set MASMINCPATH=C:\Programs\MASM32\include
...
ml /I%MASMINCPATH% /c  /coff  /Cp charactersprites.asm

if %errorlevel% neq 0 goto :error


link /SUBSYSTEM:WINDOWS  /LIBPATH:%MASMLIBPATH% game.obj blit.obj trig.obj lines.obj stars.obj bitmaps.obj libgame.obj charactersprites.obj
